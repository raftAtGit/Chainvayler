...
public class MethodTransaction implements Transaction<RootHolder> {
	...
	public MethodTransaction(IsChained target, MethodCall method, Object[] arguments) {
	...
	public String toString() {
		return String.format("MethodTransaction targetId: %s, method: %s, arguments: %s", targetId, method.getJavaMethod(), Arrays.toString(arguments));
	}
}
